...
const (
	TestService_Ping_FullMethodName = "/TestService/Ping"
)
...
func (c *testServiceClient) Ping(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
...
func (UnimplementedTestServiceServer) Ping(context.Context, *Request) (*Response, error) {
...
var TestService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "internal/server/testapi/testapi.proto",
}
